# Generated by Django 3.2.14 on 2022-08-09 14:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('end_date1', models.DateField(help_text='Usada no 3ºP para o Pré-escolar e 1º ciclo', verbose_name='Fim 1')),
                ('end_date2', models.DateField(blank=True, help_text='Usada no 3ºP para os 5º, 6º, 7º, 8º e 10º Anos', null=True, verbose_name='Fim 2')),
                ('end_date3', models.DateField(blank=True, help_text='Usada no 3ºP para os 9º, 11ª e 12º Anos', null=True, verbose_name='Fim 3')),
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Criado em')),
                ('modified', models.DateTimeField(auto_now=True, verbose_name='Modificado em')),
                ('ano_letivo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='aulas_previstas.anoletivo', verbose_name='Ano Letivo')),
            ],
